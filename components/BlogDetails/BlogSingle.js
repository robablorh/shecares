...
import gl1 from '/public/images/blog/1.jpg'
import gl2 from '/public/images/blog/2.jpg'
                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">{BlogDetails?.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">PLANNING</Link></li>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">INDUSTRIAL</Link></li>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">CREATIVE</Link></li>
                            ...
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">facebook</Link></li>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">twitter</Link></li>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">linkedin</Link></li>
                                        <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug.">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/Your-clothes-give-them-a-warm-hug." target="_blank"><Image src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-single/Your-clothes-give-them-a-warm-hug." className="author-name">Author: Bernard Rodgers</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug."><i className="ti-facebook"></i></Link></li>
                                            <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug."><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug."><i className="ti-linkedin"></i></Link></li>
                                            <li><Link href="/blog-single/Your-clothes-give-them-a-warm-hug."><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" href="/blog-single/Your-clothes-give-them-a-warm-hug."><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
